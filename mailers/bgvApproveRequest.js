...
const sendMail = ({ senderEmployer, employeeCode, receiverEmployer, lastDate, sending_to }) => {
              ...
              <tbody>
                <tr>
                  <td style="padding:38px 50px 30px 40px;text-align:center">
                    <h1 style="margin:0;font-family:'Roboto','Arial',sans-serif;font-size:21px;line-height:40px;color:#373A3C;font-weight:bold;letter-spacing:0px">Employee Information Request Approved</h1>
                  </td>
                </tr>
                <tr>
                  <td style="padding:0px 40px 40px 40px;font-family:'Roboto',sans-serif;font-size:16px;line-height:26px;color:#373A3C;text-align:left;font-weight:300">
                    <p style="margin:0 0 5px 0">The request for accessing verified background information of <b>${employeeCode}</b> is approved by <b>${receiverEmployer}</b>. The information from the application can now be accessed by the user. The access will expire on <b>${lastDate}</b> i.e. 7 days from the date of receipt of this email.<br /><br />

                    Post expiry of access, ${senderEmployer} has to raise another access request in case information access is still required.<br /><br />
                    
                    Please note that information belongs to ${receiverEmployer} and copying or circulating such information without due permission from ${receiverEmployer} is strictly prohibited.<br /><br />
                    
                    The account will be terminated immediately without any further notice if found guilty under any violation of applicable law or threatened data security.<br /><br />
  ...
  const mailOptions = {
    ...
    to: sending_to,
    subject: "Xebia BGV - Employee Information Request Approved",
    html: htmlString,
  };
