...
const sendMail = ({ name, magic_link, sending_to }) => {
              ...
              <tbody>
                <tr>
                  <td style="padding:38px 40px 0px 40px;text-align:center">
                    <h1 style="margin:0;font-family:'Roboto','Arial',sans-serif;font-size:25px;line-height:40px;color:#373A3C;font-weight:bold;letter-spacing:0px">Hi ${name}, welcome back!</h1>
                  </td>
                </tr>
                <tr>
                  <td style="padding:0px;text-align:center">
                    <img src="https://drive.google.com/uc?export=view&id=1A6BdQCymVtw_5IxJIfSYWfUAARq7Z7_Z" width="100%" alt="Welcome Back!" border="0" style="display:block;height:auto;font-family:'Roboto',sans-serif;font-size:15px;line-height:20px;color:#fff;max-width:408px;margin:0 auto" tabindex="0">
                  </td>
                </tr>
                <tr>
                      ...
                      <tbody>
                        <tr>
                          <td align="center" bgcolor="#1D1D1D" role="presentation" style="cursor:auto;padding:14px 44px;background:#6A205F;" valign="middle">
                            <a href="${magic_link}" style="text-decoration:none;background:#6A205F;color:#ffffff;font-family:'Courier',monospace;font-size:17px;font-weight:bold;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank">
                      ...
                      <tbody>
                        <tr>
                          <td style="font-family:'Roboto',sans-serif;font-size:12px;line-height:20px;color:#808080;text-align:center;font-weight:300">
                            <p>You have received this email because you requested to log into Xebia’s Web App. 
                              If you didn't request for it then you can safely ignore this email.</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
  ...
  const mailOptions = {
    ...
    to: sending_to,
    subject: "Login - Xebia Employee Background Verification",
    html: htmlString,
  };
